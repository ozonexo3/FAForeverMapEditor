...
Shader "MapEditor/FaTerrainShader" {
    Properties {
	    ...
	    //Lower Stratum
	    _SplatLower ("Layer Lower (R)", 2D) = "black" {}
...
//	    _SplatUpper ("Layer Upper (R)", 2D) = "white" {}
	...
	SubShader {
		...
		half _Splat0ScaleNormal;
		half _Splat1ScaleNormal;
		half _Splat2ScaleNormal;
		half _Splat3ScaleNormal;
		half _Splat4ScaleNormal;
		half _Splat5ScaleNormal;
		half _Splat6ScaleNormal;
		half _Splat7ScaleNormal;
