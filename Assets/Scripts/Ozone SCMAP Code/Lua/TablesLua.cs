...
namespace MapLua
{
	...
	public class TablesLua
	{
		...
		public void CreateDefault()
		{
			...
			Data.AllTables.Add(new TableKey("extraHydros", 1));
			Data.AllTables.Add(new TableKey("extraMexes", 1));

			Data.AllTables.Add(new TableKey("middleMexes", 3));
			Data.AllTables.Add(new TableKey("sideMexes", 3));
			Data.AllTables.Add(new TableKey("underwaterMexes", 3));
			Data.AllTables.Add(new TableKey("islandMexes", 3));
			Data.AllTables.Add(new TableKey("expansionMexes", 3));

			Data.AllTables.Add(new TableKey("coreMexes", 1));
			Data.AllTables.Add(new TableKey("extraBaseMexes", 1));

			Data.AllTables.Add(new TableKey("topSideMexes", 3));
			Data.AllTables.Add(new TableKey("bottomSideMexes", 3));

			Data.AllTables.Add(new TableKey("forwardCrazyrushMexes", true));
			Data.AllTables.Add(new TableKey("crazyrushOneMexes", true));
